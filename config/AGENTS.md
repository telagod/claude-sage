...
> 提示：Codex 的风格文件即 `AGENTS.md` 本身；无需额外的 style 配置文件。
...
```bash
# 仓库内（推荐）
python skills/run_skill.py <skill_name> [args...]

# 安装到 Codex 后
python ~/.codex/skills/run_skill.py <skill_name> [args...]

# 示例
python skills/run_skill.py verify-module ./my-project -v
python skills/run_skill.py verify-security ./src --json
```
